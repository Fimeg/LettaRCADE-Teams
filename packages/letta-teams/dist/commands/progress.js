...
import { teammateExists, listTeammates, loadTeammate, updateStatusSummary, getRecentStatusEvents, findStaleTeammates, addTodo, listTodoItems, startTodo, blockTodo, unblockTodo, completeTodo, dropTodo, } from "../store.js";
import { displayDashboard } from "../dashboard.js";
export function registerProgressCommands(program) {
    // STATUS COMMANDS
    ...
    todoCommand
        ...
        const filterState = options.state;
    ...
    todoCommand
        ...
        .option('--message <text>', 'Optional status message')
        .action((name, todoId, reason, options) => {
        const globalOpts = program.opts();
