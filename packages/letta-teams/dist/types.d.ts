 ...
 */
export declare const MEMFS_STARTUP_VALUES: readonly MemfsStartup[];
/**
 ...
 */
export declare function parseMemfsStartup(value: string | undefined): MemfsStartup | undefined;
/**
 * Task status for daemon operations
 */
export type TaskStatus = "pending" | "running" | "done" | "error" | "pending_review" | "reviewing" | "approved" | "rejected";
/**
...
export type DaemonResponse = {
    ...
    type: "forked";
    teammate: TeammateState;
    target: ConversationTargetState;
} | {
