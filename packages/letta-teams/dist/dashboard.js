 ...
 * Render progress bar
 */
function renderProgressBar(progress, width = 5) {
 ...
 */
function getFirstLines(text, lines) {
 ...
 */
export function displayDashboard(options = {}) {
    const { limit = DEFAULT_LIMIT, detail = false, verbose = false, json = false, sinceMinutes = 24 * 60, includeInternal = false, } = options;
