...
function optionalPromptSection(title, value) {
    if (!value)
        return "";
    return `\n## ${title}\n${quoteBlock(value)}\n`;
}
 ...
 */
export function buildInitPrompt(state) {
...
export function buildReinitPrompt(state, prompt) {
...
export function parseInitResult(result) {
